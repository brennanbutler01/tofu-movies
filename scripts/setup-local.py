...
DATABASE = "postgresql://demo:local-demo-only@127.0.0.1:5199/tofu_movies"
...
print("Local database ready. Run corepack yarn dev --port 5198. Google sign-in requires new local provider credentials; tests use temporary database sessions.")
