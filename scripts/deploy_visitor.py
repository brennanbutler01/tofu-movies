...
if project.get("projectName") != "tofu-movies-demo" or project.get("orgId") != "team_cwjFWlUVzkCIYgVepQ6Glc71":
    raise SystemExit("Link the dedicated personal tofu-movies-demo project first.")
files = subprocess.check_output(["git", "ls-files", "-z"], cwd=root).decode().split("\0")
with tempfile.TemporaryDirectory(prefix="tofu-movies-app-deploy-") as directory:
