...
if project.get("projectName") != "tofu-movies-demo" or project.get("orgId") != "team_cwjFWlUVzkCIYgVepQ6Glc71":
    raise SystemExit("Link the dedicated personal tofu-movies-demo Vercel project first.")
...
with tempfile.TemporaryDirectory(prefix="tofu-movies-deploy-") as directory:
